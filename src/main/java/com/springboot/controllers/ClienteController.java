...
import com.springboot.models.service.IUploadFileService;
...
public class ClienteController {
	...
	public String guardar(@Valid Cliente cliente, @RequestParam("file") MultipartFile foto,
			RedirectAttributes attribute, BindingResult result, Model model, SessionStatus status) {
		if (result.hasErrors()) {
	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes attribute) {
		...
		if (id > 0) {
			...
			if (uploadFileService.delete(cliente.getFoto())) {
				attribute.addFlashAttribute("info", "Foto" + cliente.getFoto() + " eliminado con exito!");
			}
